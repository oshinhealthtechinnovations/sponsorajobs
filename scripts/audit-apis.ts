...
async function auditAllApis() {
  ...
  const sources = [
    ...
    { name: "USAJobs Federal API", adapter: new USAJobsAdapter({ enabled: true, email: process.env.USAJOBS_EMAIL || "oshinhealthtechinnovations@gmail.com", apiKey: "tTjBDekl7VpbMyoaAJEDasI3+W44QV7DQ2ZO7lIpplY=" }) },
