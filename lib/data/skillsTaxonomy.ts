...
export const SKILLS_TAXONOMY: Record<string, CanonicalSkill> = {
  ...
  // Project Planning, Controls & Engineering
  "primavera_p6": {
    name: "Primavera P6",
    category: "Architecture & Tools",
    aliases: ["primavera", "p6", "oracle primavera", "primavera p6"],
    relatedSkills: [{ skill: "ms_project", weight: 0.85 }, { skill: "project_planning", weight: 0.90 }],
    isTechnical: true,
  },
  "ms_project": {
    name: "Microsoft Project",
    category: "Architecture & Tools",
    aliases: ["ms project", "msproject", "microsoft project"],
    relatedSkills: [{ skill: "primavera_p6", weight: 0.85 }, { skill: "project_planning", weight: 0.85 }],
    isTechnical: true,
  },
  "project_planning": {
    name: "Project Planning & Controls",
    category: "Domain",
    aliases: [
      "project planning",
      "project controls",
    ...
    relatedSkills: [{ skill: "evm", weight: 0.85 }, { skill: "primavera_p6", weight: 0.90 }, { skill: "cost_control", weight: 0.80 }],
    isTechnical: true,
  },
  "evm": {
    name: "Earned Value Management (EVM)",
    category: "Domain",
    aliases: ["evm", "earned value", "spi", "cpi", "schedule variance", "cost variance", "s-curve analysis", "variance analysis"],
    relatedSkills: [{ skill: "project_planning", weight: 0.85 }, { skill: "cost_control", weight: 0.85 }],
    isTechnical: true,
  },
  "cost_control": {
    name: "Cost & Budget Controls",
    category: "Domain",
    aliases: ["cost control", "cost monitoring", "budget monitoring", "cost forecasting", "financial controls", "financial reporting"],
    relatedSkills: [{ skill: "evm", weight: 0.85 }, { skill: "project_planning", weight: 0.80 }],
    isTechnical: true,
  },
  "autocad": {
    name: "AutoCAD / Civil 3D",
    category: "Architecture & Tools",
    aliases: ["autocad", "cad", "civil 3d", "2d cad", "3d cad"],
    relatedSkills: [{ skill: "revit", weight: 0.80 }, { skill: "staad_pro", weight: 0.70 }],
    isTechnical: true,
  },
  "revit": {
    name: "Revit / BIM",
    category: "Architecture & Tools",
    aliases: ["revit", "bim", "building information modeling"],
    relatedSkills: [{ skill: "autocad", weight: 0.80 }, { skill: "civil_engineering", weight: 0.80 }],
    isTechnical: true,
  },
  "staad_pro": {
    name: "STAAD Pro / Structural Analysis",
    category: "Architecture & Tools",
    aliases: ["staad pro", "staad.pro", "staad", "structural analysis"],
    relatedSkills: [{ skill: "autocad", weight: 0.75 }, { skill: "civil_engineering", weight: 0.85 }],
    isTechnical: true,
  },
  "civil_engineering": {
  ...
  "power_bi": {
    ...
    category: "AI & Data",
    aliases: ["power bi", "powerbi", "power query", "power pivot", "dax", "kpi dashboards"],
    relatedSkills: [{ skill: "excel", weight: 0.85 }, { skill: "data engineering", weight: 0.70 }],
    isTechnical: true,
  },
  "excel": {
    name: "Advanced Excel",
    category: "Architecture & Tools",
    aliases: ["advanced excel", "excel", "spreadsheets", "pivot tables", "excel vba"],
    relatedSkills: [{ skill: "power_bi", weight: 0.80 }],
    isTechnical: true,
  },
  "agile": {
    name: "Agile / Scrum",
