...
const CAREER_ROUTES: RouteDefinition[] = [
  {
    ...
    qualificationCriteria: [
      ...
      "Eligible for 5-year Indefinite Leave to Remain (ILR) fast-track",
    ],
  ...
  },
  {
    ...
    qualificationCriteria: [
      ...
      "Qualifies under TSMIT statutory minimum salary threshold (AUD $73,150)",
      "Direct pathway to Permanent Residency via Subclass 186 Employer Nomination",
    ],
  ...
  },
  {
    ...
    qualificationCriteria: [
      ...
      "Direct allocation of Certificate of Sponsorship from A-rated sponsor",
    ],
  ...
  },
  {
    ...
    qualificationCriteria: [
      ...
      "Eligible for Canadian Express Entry Canadian Experience Class PR",
    ],
  ...
  },
  {
    ...
    qualificationCriteria: [
      ...
      "Direct placement with NHS Trust or licensed private healthcare group",
    ],
